...
public class SistemaParqueo {
        ...
        if (parqueo.isEmpty()) {
            ...
            for (RegistroParqueo registro : parqueo) {
                ParqueoActual += ("\n\n Usuario: " + registro.usuario.nombre + " " + registro.usuario.apellido +
                                  ...
                                  +" Placa: " + registro.usuario.placa
                                  +" Posicion: " + registro.usuario.PosicionEstacionado
        ...
        if (parqueo.isEmpty()) {
            ...
            for (RegistroParqueo registro : parqueo) {
                ...
                mostrarIngresos += ("\n\nEstacionamiento Numero: " + (i+1)
                                  + " Horas Parqueado: " + registro.horasParqueo 
                                  + " Placa: " + registro.usuario.placa
                                  + " ID: " + registro.usuario.PosicionEstacionado
                                  + " Total a Pagar: "+ registro.usuario.montoAPagar
                                  + " \nFecha:" +registro.usuario.fechaIngreso);
                                  i +=1;
    ...
    public String Reporte3(ConfigParqueo park){
        ...
        if (parqueo.isEmpty()) {
            mostrarUso += ("El parqueo está vacío.");
        ...
        if (usuario != null) {
               ...
               switch(choice){
                   ...
                   case 1: // funcion de parquear
                       ...
                       try{
                       if(park.iniciado == 1  && usuario.EstaEstacionado == false){ //Validacion: usuario ha sido configurado y el usuario no esta estacionado en el parqueo
                            ...
                            if(allgood ==2){ // Se procede si si cumplen los requisitos
                                ...
                                parquear(usuario, usuario.horasEstacionado, pagar, usuario.placa,usuario.montoAPagar,usuario.PosicionEstacionado, usuario.fechaIngreso
